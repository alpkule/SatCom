...
Delta_theta_Yx_approximate = -e_Y * cosd(Beta)*( sind(alfa)*cosd(Beta)+(e_Y/2)*sind(Beta) );
Delta_theta_Yy_approximate = e_Y* cosd(alfa_prime) * (cosd(alfa_prime*Beta_prime)-sind(alfa_prime)*e_Y/2);
